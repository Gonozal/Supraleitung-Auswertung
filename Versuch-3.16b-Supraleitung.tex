...
Selbst wenn von den offensichtlich falschen Messergebnissen für 0.06T, 0.08T und 0.10T abgesehen wird, liegen die gemessenen Werte für die Sprungtemperatur in Abhängigkeit eines externen Magnetfeldes allesamt über dem vom Modell vorhergesagten Verlauf, was einen systematischen Fehler suggeriert. Dieser könnte von der Verunreinigung der Kontakte zur Widerstandsmessung mit Lötzin verursacht werden, da die im Lötmaterial vorhandenen supraleitenden Metalle andere kritische Magnetfelder aufweisen können.

Um sinnvolle Aussagen über das Zwei-Flüssigkeiten-Modell zu treffen, müsste der Versuch mit einem von Verunreinigungen befreiten Supraleiter und, sofern möglich, bei höhren externen Magnetfeldern, wiederholt werden.
